 ...
 * @since 1.0.0
 */
public class MongoDBMapReduceDialog extends BaseStepDialog implements StepDialogInterface {

  /** for i18n purposes. **/
  private static final Class<?> PKG = MongoDBMapReduceDialog.class;
  ...
  public MongoDBMapReduceDialog(Shell parent, BaseStepMeta in, TransMeta transMeta, String sname) {
